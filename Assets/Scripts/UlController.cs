...
{ 
    ...
    public Sprite heartFull, heartEmpty, heartHalfFull;
     
    public Text gemText;

    public Image fadeScreen;
    public float fadeSpeed;
    private bool shouldFadeToBlack,shouldFadeFromBack;
